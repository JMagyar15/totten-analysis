"""
SCRIPT DOWNLOADS THE RELEVANT SEISMIC DATA FOR TOTTEN ANALYSIS USING THE OBSPY MASS DOWNLOADER. THIS INCLUDES DATA FROM DECIMATED CHANNELS AND ADDITIONAL B AND C STATIONS THAT ARE NOT USED IN THE FOLLOWING ANALYSIS
"""
