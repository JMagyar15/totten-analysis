"""
SCRIPT FOR COMPUTING THE MOMENT MAGNITUDE FOR EACH OF THE TEMPLATE MATCHED EVENTS USING A FIT OF THE BRUNE SPECTRUM.
THIS IS DONE BY ESTIMATING THE MAGNITUDE FOR THE STACKED WAVEFORM FOR EACH CLUSTER FROM THE P WAVE WINDOW, THEN USING A RATIO OF THE ENERGY
WITHIN THIS WINDOW FOR EACH EVENT TO DETERMINE THE MAGNITUDE OF INDIVIDUAL EVENTS. THE OUTPUT MISFIT SURFACES FROM LOCATION_INVERSION.PY
ARE USED TO DETERMINE SOURCE DISTANCE AND PROPAGATE ERRORS.
"""
